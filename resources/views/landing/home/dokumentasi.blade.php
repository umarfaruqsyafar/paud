...
@section('container')
    ...
    <section id="layanan" class="bg-dasar">
        <div class="container px-4 py-5">
            <h2 class="pb-2 writertext text-title">{{ $judul }}
            </h2>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="/about_us/doc/{{ $jenis }}/*" class="dropdown-item" href="#">Semua Dokumentasi</a></li>
                        @foreach ($kegiatan as $k)
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a href="/about_us/doc/{{ $jenis }}/{{ $k->id }}" class="dropdown-item"
                                    href="#">{{ $k->judul }}</a></li>
                        @endforeach
                    </ul>
